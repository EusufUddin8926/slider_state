...
class SlideActionState extends State<SlideAction> with TickerProviderStateMixin {
                              ...
                              child: GestureDetector(
                                ...
                                onHorizontalDragEnd: (details) async {
                                  ...
                                  if (_progress <= widget.trigger || widget.onSubmit == null) {
                                    // Only reset the slider when the trigger is not reached
                                    await resetToStartPosition();
                                  } else {
  ...
  void onHorizontalDragUpdate(DragUpdateDetails details) {
    setState(() {
      _dx = (_dx + details.primaryDelta!).clamp(0.0, _maxDx);
    });
  }
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      _maxDx = _containerWidth! - (sliderWidth / 2) - 34 - widget.sliderButtonYOffset;
    });
  }
